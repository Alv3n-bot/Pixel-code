  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden rounded-3xl bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 px-4 py-4 sm:px-8 sm:py-20">
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        go digital with smart
          </span>{" "}
        software solutions
        </h1>

        <p className="text-base sm:text-lg md:text-xl text-slate-300 mb-8 sm:mb-10 leading-relaxed max-w-2xl font-medium">
          We craft <span className="text-white font-bold">modern, lightning-fast</span> websites, e-commerce stores, and digital solutions. Build trust, reach more customers, and grow your business online.
        </p>
      ...
      <div className="hidden xl:block absolute right-12 top-1/2 -translate-y-1/2 backdrop-blur-md bg-slate-900/50 border border-purple-500/30 rounded-3xl p-6 lg:p-8 shadow-xl shadow-purple-500/20 max-w-xs hover:scale-105 transition-transform duration-500 transform-gpu will-change-transform">
        ...
        <div className="grid grid-cols-2 gap-3 lg:gap-4">
          <div>
            <div className="font-black text-white text-base lg:text-lg">1-6 weeks</div>
